...
<body>
                 <form class="form-horizontal form-label-left" >                     
                      ...
                      <span class="section ">Edit Merchant | <small></small></span>
...
ExecuteQuery(katakunci,function(results){
  ...
  document.getElementById("Merchan_Name").value = b[0]['Merchan_Name'];
  document.getElementById("Username").value =  b[0]['Username'];
  document.getElementById("First_Name").value =  b[0]['First_Name'];
  document.getElementById("Mid_Name").value =  b[0]['Mid_Name'];
  document.getElementById("Last_Name").value =  b[0]['Last_Name'];
  document.getElementById("Location").value =  b[0]['Location'];
  document.getElementById("No_rek").value =  b[0]['No_rek'];
});
...
const com = {
  ...
  $.ajax({
    type: "POST",
    url:  "https://api.ignasiusleo.com/merchant/update",
      data: com,
    dataType: "json",
