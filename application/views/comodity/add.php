...
<body>
                 <form class="form-horizontal form-label-left" >
                      ...
                      <p>To Add Items please complete the form , <code>*</code> means required <a href="form.html">data</a>
                      </p>
                      <span class="section ">Creat New Items </span>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">ID Items <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="telephone">Shop Name <span class="required">*</span>
                        </label>
