...
<li id="menu-item-22" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-22"><a href="https://drive.google.com/open?id=1y8WIZhuZWnYuowzMLJljuHpYp0ab68Lj">Contact</a></li>
...
<div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="main">
          <br>
    		<table class="table table-hover" style="border-color: red; border-style: none;">
				<thead>
        			<tr class="">
...
/*function search(){
	...
	ExecuteQuery(katakunci,function(results){
	    ...
	    function goFun(sta,limit) {
			...
			var $nr = $('<tr><td><img width="300" height="400"  src="http://localhost/Mopay/assets/home/production/images/'+i+'.jpg" alt="image" class="attachment-best-commerce-product size-best-commerce-product"/></td><td><center><h3 class="woocommerce-loop-product__title">'+b[i]['Name']+'</center></h3></td><td><h5 class="">Rp <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">Rp</span>'+ b[i]['Price']+'</span></h5>Quantity : ' + b[i]['qty'] +'</td><td><a class="woocommerce-loop-product__title">' + b[i]['Description'] +'</a></td><td>    <a class="woocommerce-Price-amount amount" href="<?php echo base_url()?>index.php/comodity/payment2/'+b[i]['ID_Com'] +'" >Buy Now <h3><i class="fa fa-money"></i></h3></a>'+ '</td></tr>');
        		table.append($nr);
		 	}
		}
	});
...
$(document).ready(function(){		
	ExecuteQuery("{}", function(results) {
		...
		var limit = elements_per_page;
	 	...
	 	function goFun(sta,limit) {
	  		for (var i =sta ; i < limit; i++) {
				var $nr = $('<tr><td><img width="300" height="400"  src="http://localhost/Mopay/assets/home/production/images/'+i+'.jpg" alt="image" class="attachment-best-commerce-product size-best-commerce-product"/></td><td><center><h3 class="woocommerce-loop-product__title">'+b[i]['Name']+'</center></h3></td><td><h5 class=""><span class="woocommerce-Price-currencySymbol">Rp </span>'+ b[i]['Price']+',-</span></h5>Quantity : ' + b[i]['qty'] +'</td><td><a class="woocommerce-loop-product__title">' + b[i]['Description'] +'</a></td><td>    <a class="woocommerce-Price-amount amount" href="<?php echo base_url()?>index.php/comodity/payment2/'+b[i]['ID_Com'] +'" >Checkout <h3><center><i class="fa fa-money"></i></center></h3></a></td></tr>');
	    		table.append($nr);
	  		}
	  	}
